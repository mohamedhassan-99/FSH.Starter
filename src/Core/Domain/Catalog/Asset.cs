...
public class Asset : AuditableEntity, IAggregateRoot
{
    ...
    public Asset(string name, string? description, decimal rate, Guid brandId, Guid categoryId, Guid projectId, string? imagePath)
    {
        Name = name;
    ...
    public Asset Update(string? name, string? description, decimal? rate, Guid? brandId, Guid? categoryId, Guid? projectId, string? imagePath)
    {
